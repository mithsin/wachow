...
export const CarouselCubeCard = (props) => {
    const { id: itemId, shopItemsId, shopName, images, pickUpLocations } = props
    // console.log('CarouselCubeCard-props-->: ', props)
    return (
        <div className={styles.cardContainer}>
            ...
            <div>
                <Link to={`/shop/${shopItemsId}/i/${itemId}`} className={styles.itemTitle}>
                    <h3>{shopName}</h3>
                </Link>
            </div>
        </div>
