import AddPickUpLocationForm from './index';
import { BrowserRouter } from 'react-router-dom';
import { Provider } from 'react-redux';
import { store } from "store/store";
// More on how to set up stories at: https://storybook.js.org/docs/react/writing-stories/introduction
const meta = {
  title: 'components/Organisms/Forms/AddPickUpLocationForm',
  component: AddPickUpLocationForm,
  tags: ['autodocs'],
  decorators: [
    (Story) => (
      <BrowserRouter>
...
const Template = (props) => {
  ...
  return(
    <AddPickUpLocationForm userData={mockData} />
  )
}
