...
export default function ItemUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = itemRecord
      ...
      : initialValues;
    setShopName(cleanValues.shopName);
    setName(cleanValues.name);
    setIngrediances(cleanValues.ingrediances);
    ...
    >
      <TextField
        ...
        onChange={(e) => {
          ...
          if (errors.shopName?.hasError) {
            runValidationTasks("shopName", value);
          }
          setShopName(value);
        }}
        onBlur={() => runValidationTasks("shopName", shopName)}
        errorMessage={errors.shopName?.errorMessage}
        hasError={errors.shopName?.hasError}
        {...getOverrideProps(overrides, "shopName")}
      ></TextField>
      <TextField
        label="Name"
        isRequired={false}
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (errors.ingrediances?.hasError) {
            runValidationTasks("ingrediances", value);
          }
          setIngrediances(value);
        }}
        onBlur={() => runValidationTasks("ingrediances", ingrediances)}
